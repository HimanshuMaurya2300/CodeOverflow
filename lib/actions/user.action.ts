...
export async function deleteUser(params: DeleteUserParams) {
    try {
        ...
        // delete user and its questions, answers, comments, etc

        // get user questions
        const userQuestions = await Question.find({ author: user._id }).distinct('author')

        // delete user questions
        await Question.deleteMany({ author: user._id })

        // delete user comments and answer, etc
...
export async function toogleSaveQuestions(params: ToggleSaveQuestionParams) {
    try {
        connectToDatabase()
